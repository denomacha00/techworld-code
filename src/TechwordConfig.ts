...
// about the upstream provider, and is safe to ship. A user can also override it per-install with the
// techwordCode.updateUrl setting.
export const TECHWORD_UPDATE_URL = 'https://techworld-code-production.up.railway.app/latest.json';
